...
if (tasks.findByName("prepareKotlinBuildScriptModel") == null) {
  tasks.register("prepareKotlinBuildScriptModel") {
    description = "Stub task for Android Studio / IntelliJ Kotlin DSL script sync compatibility"
  }
}
...
android {
  ...
  signingConfigs {
    ...
    // Smart check: Only configure debugConfig if the workspace's debug.keystore exists
    val localDebugKeystore = file("${rootDir}/debug.keystore")
    if (localDebugKeystore.exists()) {
      create("debugConfig") {
        storeFile = localDebugKeystore
...
dependencies {
  ...
  // Newly added dependencies for Zubflix XML and media views
